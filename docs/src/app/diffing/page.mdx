...
<table>
  ...
  <tbody>
    ...
    <tr><td><code>--max-siblings &lt;n&gt;</code></td><td>Collapse long same-role sibling runs in the current snapshot (default 50, or <code>AGENT_BROWSER_SNAPSHOT_MAX_SIBLINGS</code>; 0 shows all)</td></tr>
  </tbody>
</table>
