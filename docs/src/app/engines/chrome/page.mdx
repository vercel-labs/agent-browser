...
<table>
  ...
  <tbody>
    ...
    <tr><td>Default managed profile</td><td><code>~/.agent-browser/runtime-profiles/default/user-data</code> when <code>--profile</code> and <code>--runtime-profile</code> are omitted</td></tr>
    <tr><td>Persistent profiles</td><td><code>--profile &lt;path&gt;</code> (overrides Chrome's <code>--user-data-dir</code>)</td></tr>
    <tr><td>Named runtime profiles</td><td><code>--runtime-profile &lt;name&gt;</code> selects <code>~/.agent-browser/runtime-profiles/&lt;name&gt;/user-data</code></td></tr>
    <tr><td>Storage state</td><td><code>--state &lt;path&gt;</code></td></tr>
    <tr><td>File URL access</td><td><code>--allow-file-access</code></td></tr>
    <tr><td>Headed mode</td><td><code>--headed</code> (defaults <code>DISPLAY</code> to <code>:0.0</code> on Unix when unset)</td></tr>
