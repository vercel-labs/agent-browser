...
When you pass multiple custom switches via <code>--args</code>, separate switches with commas or newlines. Commas inside one switch are preserved, so headed launches like <code>--window-size=1600,1200</code> reach Chrome unchanged.
