...
<table>
  ...
  <tbody>
    <tr><td><code>record start &lt;path.webm|path.mp4&gt; [url] [--fps &lt;n&gt;]</code></td><td>Start recording to a WebM or MP4 file</td></tr>
    <tr><td><code>record stop</code></td><td>Stop the active recording and save the file</td></tr>
    <tr><td><code>record restart &lt;path.webm|path.mp4&gt; [url] [--fps &lt;n&gt;]</code></td><td>Stop the current recording and immediately start another</td></tr>
  </tbody>
</table>
