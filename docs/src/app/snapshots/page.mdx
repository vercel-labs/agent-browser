...
agent-browser snapshot --diff             # Incremental diff vs last snapshot
...
<table>
  ...
  <tbody>
    ...
    <tr><td><code>--diff</code></td><td>Return unified diff vs previous snapshot with context lines (uses Myers algorithm)</td></tr>
    <tr><td><code>-o, --output</code></td><td>Save snapshot (or diff) to a file instead of stdout</td></tr>
  </tbody>
</table>
