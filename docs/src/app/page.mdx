...
```bash
npm install -g agent-browser-priv # macOS ARM64, Linux x64, Linux ARM64
...
- **Cross-platform**: macOS ARM64, Linux x64, and Linux ARM64 with native binaries
...
Native Rust binaries for macOS ARM64, Linux x64, and Linux ARM64. Windows release artifacts are temporarily disabled.
