...
- **nextjs** — Next.js dev workflows on top of the React primitives. PPR shell analysis, runtime prefetching, hydration + re-render profiling, `/_next/mcp` bridge (errors, logs, routes, server actions), dev-server restart.
