...
<table>
  ...
  <tbody>
    ...
    <tr><td><code>--args &lt;args&gt;</code></td><td>Browser launch args. Separate switches with commas or newlines. Commas inside one switch such as <code>--window-size=1600,1200</code> are preserved.</td></tr>
