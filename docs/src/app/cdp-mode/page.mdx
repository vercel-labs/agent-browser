...
<table>
  ...
  <tbody>
    ...
    <tr><td><code>-p &lt;provider&gt;</code></td><td>Cloud browser provider (<code>browserbase</code>, <code>browseruse</code>, <code>hyperbrowser</code>, <code>kernel</code>, <code>browserless</code>)</td></tr>
