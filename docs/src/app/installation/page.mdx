...
<tr><td>Old state files</td><td>Deletes state files older than <code>AGENT_BROWSER_STATE_EXPIRE_DAYS</code> (default 30); setting it to <code>0</code> disables expiration</td></tr>
