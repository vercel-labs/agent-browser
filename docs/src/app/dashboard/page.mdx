...
Then open `http://localhost:4848` or your forwarded/proxied dashboard URL, such as a [Portless](https://github.com/vercel-labs/portless) URL, in a browser to see the live dashboard.
