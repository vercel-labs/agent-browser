...
```bash
# Set expiration (default: 30 days; use 0 to disable automatic expiration)
...
<table>
  ...
  <tbody>
    ...
    <tr><td><code>AGENT_BROWSER_STATE_EXPIRE_DAYS</code></td><td>Auto-delete states older than N days (default: 30; <code>0</code> disables)</td></tr>
  </tbody>
</table>
