...
--bridge-platform <mode> # Bridge opener platform (auto, linux, windows)
--bridge-browser <mode>  # Bridge browser (auto, edge, chrome)
--bridge-profile-directory <name> # Bridge profile directory (e.g., "Profile 1")
