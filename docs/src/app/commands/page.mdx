...
agent-browser eval <js>               # Run JavaScript in the selected frame
...
`eval` runs in the selected frame. With no frame selected, or after `frame main`, it runs in the top-level page.
