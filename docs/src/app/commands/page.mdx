...
--allowed-domains <list>    # Restrict navigation and resource domains
--navigation-domains <list> # Restrict only agent-initiated navigation
--resource-domains <list>   # Restrict only page-initiated sub-resources
