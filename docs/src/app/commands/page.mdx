...
--ca-cert <path>         # Add a CA for CLI TLS/read/install and local Chromium on Linux
--no-ca-cert             # Clear the extra CLI CA bundle; browser commands also clear browser CA
