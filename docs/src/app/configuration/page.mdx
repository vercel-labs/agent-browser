...
Global launch, output, provider, and chat options can be set in the config file using their camelCase equivalent. Command-scoped flags such as `screenshot --full` remain command arguments. Runtime viewport settings can also be pinned for every launched session.
...
<table>
  ...
  <tbody>
    ...
    <tr><td><code>viewport</code></td><td><code>set viewport &lt;width&gt; &lt;height&gt;</code></td><td>object with <code>width</code> and <code>height</code></td></tr>
    <tr><td><code>deviceScaleFactor</code></td><td><code>set viewport &lt;width&gt; &lt;height&gt; &lt;scale&gt;</code></td><td>number</td></tr>
