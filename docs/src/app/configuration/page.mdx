...
<table>
  ...
  <tbody>
    ...
    <tr><td><code>AGENT_BROWSER_ARGS</code></td><td>Comma or newline separated browser launch arguments. Repeated <code>--disable-features</code> entries merge with the built-in <code>Translate</code> opt-out. On Linux, a custom <code>--use-angle</code> that conflicts with <code>--webgpu</code> causes a launch error.</td><td>(none)</td></tr>
