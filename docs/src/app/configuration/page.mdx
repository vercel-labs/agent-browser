...
<table>
  ...
  <tbody>
    ...
    <tr><td><code>AI_GATEWAY_API_KEY</code></td><td>API key for the Vercel AI Gateway. Required to enable AI chat and the <code>goal</code> command.</td><td>(none)</td></tr>
    ...
    <tr><td><code>AGENT_BROWSER_GOAL_MODEL</code></td><td>Evaluation model for the <code>goal</code> command.</td><td><code>typesafe-ai/jev</code></td></tr>
    <tr><td><code>AGENT_BROWSER_GOAL_TEXT_MODEL</code></td><td>Text model that writes <code>TYPE_TEXT</code> values for the <code>goal</code> command.</td><td><code>inception/mercury-2.5</code></td></tr>
  </tbody>
</table>
