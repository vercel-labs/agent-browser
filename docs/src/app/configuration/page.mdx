...
<table>
  ...
  <tbody>
    ...
    <tr><td><code>provider</code></td><td><code>-p, --provider</code></td><td>string (<code>ios</code>, <code>browserbase</code>, <code>browseruse</code>, <code>kernel</code>, <code>steel</code>)</td></tr>
