...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>
        <code>bridgePort</code>
      </td>
      <td>
        <code>AGENT_BROWSER_BRIDGE_PORT</code>
      </td>
      <td>number (1-65535)</td>
    </tr>
    <tr>
      <td>
      ...
      <td>
        <code>AGENT_BROWSER_BRIDGE_TOKEN</code>
      </td>
      <td>string</td>
    </tr>
    <tr>
      <td>
        <code>bridgeExtensionId</code>
      </td>
      <td>
        <code>AGENT_BROWSER_BRIDGE_EXTENSION_ID</code>
      </td>
      <td>string</td>
    </tr>
    <tr>
      <td>
        <code>bridgePlatform</code>
      </td>
      <td>
        <code>--bridge-platform</code> / <code>AGENT_BROWSER_BRIDGE_PLATFORM</code>
      </td>
      <td>
        <code>auto</code> | <code>linux</code> | <code>windows</code>
      </td>
    </tr>
    <tr>
      <td>
        <code>bridgeBrowser</code>
      </td>
      <td>
        <code>--bridge-browser</code> / <code>AGENT_BROWSER_BRIDGE_BROWSER</code>
      </td>
      <td>
        <code>auto</code> | <code>edge</code> | <code>chrome</code>
      </td>
    </tr>
    <tr>
      <td>
        <code>bridgeProfileDirectory</code>
      </td>
      <td>
        <code>--bridge-profile-directory</code> /{' '}
        <code>AGENT_BROWSER_BRIDGE_PROFILE_DIRECTORY</code>
      </td>
      <td>string</td>
    </tr>
    <tr>
