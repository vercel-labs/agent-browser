...
<table>
  ...
  <tbody>
    ...
    <tr><td><code>AGENT_BROWSER_STATE_EXPIRE_DAYS</code></td><td>Auto-delete saved session states older than N days. Set to <code>0</code> to disable expiration.</td><td><code>30</code></td></tr>
