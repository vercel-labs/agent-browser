...
<table>
  ...
  <tbody>
    ...
    <tr><td><code>AGENT_BROWSER_IDLE_TIMEOUT_MS</code></td><td>Auto-shutdown the daemon after N ms without commands or dashboard input. Set <code>0</code> to disable. Headed browsers, Safari and iOS WebDriver sessions, and attached browsers are exempt from the default, but an explicit value applies to every browser.</td><td><code>3600000</code> (1 hour)</td></tr>
