...
<table>
  ...
  <tbody>
    ...
    <tr><td><code>screenshotFormat</code></td><td><code>--screenshot-format</code></td><td>string (<code>png</code>, <code>jpeg</code>); used only when the output path has no <code>.png</code>, <code>.jpg</code>, or <code>.jpeg</code> extension</td></tr>
