...
<table>
  ...
  <tbody>
    ...
    <tr><td><code>AGENT_BROWSER_DASHBOARD_VIEWPORT_ONLY</code></td><td>Show only the dashboard viewport when set to <code>1</code>. Use <code>0</code> or unset it for the full dashboard layout.</td><td><code>0</code></td></tr>
