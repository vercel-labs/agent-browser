...
<table>
  ...
  <tbody>
    ...
    <tr><td><code>allowedDomains</code></td><td><code>--allowed-domains</code></td><td>string[] for navigation and resources</td></tr>
    <tr><td><code>navigationDomains</code></td><td><code>--navigation-domains</code></td><td>string[] for agent-initiated navigation</td></tr>
    <tr><td><code>resourceDomains</code></td><td><code>--resource-domains</code></td><td>string[] for page-initiated resources</td></tr>
...
<table>
  ...
  <tbody>
    ...
    <tr><td><code>AGENT_BROWSER_ALLOWED_DOMAINS</code></td><td>Comma-separated allowed domain patterns for navigation and resources (e.g., <code>example.com,*.example.com</code>).</td><td>(unrestricted)</td></tr>
    <tr><td><code>AGENT_BROWSER_NAVIGATION_DOMAINS</code></td><td>Comma-separated allowed domain patterns for agent-initiated navigation only.</td><td>(unrestricted)</td></tr>
    <tr><td><code>AGENT_BROWSER_RESOURCE_DOMAINS</code></td><td>Comma-separated allowed domain patterns for page-initiated resources only.</td><td>(unrestricted)</td></tr>
