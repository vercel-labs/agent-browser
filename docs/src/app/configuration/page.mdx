...
<table>
  ...
  <tbody>
    ...
    <tr><td><code>AGENT_BROWSER_IDLE_TIMEOUT_MS</code></td><td>Auto-shutdown the daemon after N ms of inactivity. Queued and running commands hold an activity lease. Set to <code>0</code> to disable.</td><td><code>14400000</code> (4 hours)</td></tr>
