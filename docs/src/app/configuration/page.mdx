...
When `bridgePlatform` is `windows`, agent-browser opens the default Windows browser first. If the extension does not connect, it logs a warning and retries with Chrome, Edge, Brave, then Chromium.
