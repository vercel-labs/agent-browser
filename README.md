...
| `--args <args>` | Browser launch args, newline-separated or comma-separated between switches. Commas inside one switch are preserved, e.g. `--window-size=1600,1200` (or `AGENT_BROWSER_ARGS` env) |
