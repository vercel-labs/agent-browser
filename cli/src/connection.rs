...
fn get_port_for_session(session: &str) -> u16 {
    ...
    // Note: Apply modulo before casting to u16 to match daemon.js behavior.
    // (hash.abs() as u16) % 16383 would truncate first, giving different results
    // when hash.abs() > 65535. Example: 70000 → truncated: 4464, correct: 4468
