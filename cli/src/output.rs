...
Options:
  ...
  --engine <name>            Browser engine: chrome (default), lightpanda, aginxbrowser (or AGENT_BROWSER_ENGINE)
...
Environment:
  ...
  AGENT_BROWSER_ENGINE           Browser engine: chrome (default), lightpanda, aginxbrowser
