...
Options:
  ...
  -p, --provider <name>      Browser provider: ios, browserbase, hyperbrowser, kernel, browseruse, browserless
...
Environment:
  ...
  AGENT_BROWSER_PROVIDER         Browser provider (ios, browserbase, hyperbrowser, kernel, browseruse, browserless)
