...
Options:
  ...
  --allowed-domains <list>   Restrict network domains; rejects CDP, auto-connect, profiles, direct-page providers, unsafe startup args, iOS/Safari (or AGENT_BROWSER_ALLOWED_DOMAINS)
