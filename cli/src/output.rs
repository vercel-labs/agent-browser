...
Options:
  ...
  --idle-timeout <time>      Auto-shutdown after inactivity (default: 4h, 0 disables)
...
Environment:
  ...
  AGENT_BROWSER_IDLE_TIMEOUT_MS  Auto-shutdown after N ms of inactivity (default: 14400000, 0 disables)
