...
BROWSER_USE_PROXY_COUNTRY="de"               # Two-letter proxy country; Cloud validates availability; none/direct disables it
BROWSER_USE_TIMEOUT_MINUTES="60"             # Cloud browser timeout from 1 to 240 minutes
BROWSER_USE_SCREEN_WIDTH="1440"              # Set together with BROWSER_USE_SCREEN_HEIGHT
BROWSER_USE_SCREEN_HEIGHT="900"              # Set together with BROWSER_USE_SCREEN_WIDTH
BROWSER_USE_ALLOW_RESIZING="false"           # Allow resizing; may reduce stealthiness
