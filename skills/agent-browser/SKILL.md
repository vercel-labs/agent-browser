...
### Connect via Playwright MCP Bridge Extension

```bash
# Use your real Chromium tab through the Playwright MCP Bridge extension
...
export AGENT_BROWSER_BRIDGE_PORT=9223
