...
# Get page metadata
echo "Page title: $(npx agent-browser get title)"
echo "Page URL: $(npx agent-browser get url)"
...
# npx agent-browser get text @e1 > "$OUTPUT_DIR/main-content.txt"

# Extract specific elements (uncomment as needed)
# npx agent-browser get text "article" > "$OUTPUT_DIR/article.txt"
# npx agent-browser get text "main" > "$OUTPUT_DIR/main.txt"
# npx agent-browser get text ".content" > "$OUTPUT_DIR/content.txt"
